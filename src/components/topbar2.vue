...
<template>
  ...
  <div style="position: fixed;z-index: 100;width: 100vw;height:8vh;background-color: white;box-shadow: 1px 1px 1px 1px rgba(187, 185, 185, 0.25);" >
    ...
    <router-link to="/"><div v-if="this.whichpage===1" style="position: absolute;width: 29px;height:14px;left:23vw;top:3.1vh;font-style: normal;font-weight: 600;font-size: 14px;line-height: 14px;letter-spacing: 0.01em;color: #2B2B39;cursor: pointer" @click="which_page(1)">首页</div></router-link>
    ...
    <router-link to="/ScholarLibrary"><div v-if="this.whichpage===5" style="position: absolute;width: 57px;height:14px;left:48vw;top:3.1vh;font-style: normal;font-weight: 600;font-size: 14px;line-height: 14px;letter-spacing: 0.01em;color:  #2B2B39;cursor: pointer" @click="which_page(5)">学者库</div></router-link>
