...
<template>
  <div style="position: fixed;z-index: 9999;width: 100vw;height:8vh; background-color: white">
    ...
    <div style="position: absolute; left:75vw;top:1.3vh;box-shadow: 0 7px 22px -6px rgba(33, 123, 244, 0.34);color: white"><v-btn style="background-color: #217BF4;" class="white--text">登 录</v-btn></div>
