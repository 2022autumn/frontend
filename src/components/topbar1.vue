...
<template>
  <div style="position: fixed;z-index: 100;width: 100vw;height:9vh; background-color: white;box-shadow: 1px 1px 1px 1px rgba(187, 185, 185, 0.25);">
    ...
    <div style="position: absolute; left:75vw;top:2.3vh;box-shadow: 0 7px 22px -6px rgba(33, 123, 244, 0.34);color: white"><v-btn style="background-color: #217BF4;" class="white--text" @click="open_login()">登 录</v-btn></div>
    <img :src="this.photourl" style="top: 1.7vh;width: 40px;height: 40px;border-radius: 50px;left: 90vw;position: absolute" alt="">
    <div style="position: absolute;width: 45px;height:14px;left:94vw;top:3.5vh;font-style: normal;font-weight: 600;font-size: 14px;line-height: 14px;letter-spacing: 0.01em;color: #2B2B39;">{{this.username}}</div>
