      ...
      <div>
          ...
          <div>
            <div class="content grid1">
              ...
              <div v-if="this.ifedit === 0">
                ...
                <div class="info-text">
                  <span>真实姓名:</span>{{ this.realname }}
                </div>
                <div class="info-text">
                  <span>联系电话:</span>{{ this.phone }}
                </div>
                <div class="info-text"><span>Email:</span>{{ this.email }}</div>
                <div class="info-text">
                  <span>研究领域:</span>{{ this.field }}
                </div>
            ...
            <div
              ...
              v-if="this.ifedit === 1"
            >
              <el-button class="btn" size="medium " @click="outedit"
                >确认</el-button
              >
            </div>
          </div>
        ...
        <div v-show="activeIndex == 2" class="center">
          ...
          <div>
            ...
            <div style="text-align: center; margin-top: 6vh">
              <el-button class="btn" size="medium " @click="resetpass"
                >确定</el-button
              >
            </div>
          </div>
