    ...
    <div v-else>
      ...
      <div style="position:absolute;left:20vw;height: 75vh;top:275vh;width: 100vw;">
          ...
          <el-card v-if="index < item.lenth" class="outcome-card" style="width:60vw;height:228px; " shadow="hover">
            ...
            <div v-if="is_mine || verified" style="display: inline-block;float: right;">
              ...
              <div v-if="item.pdf === 0" style="display: inline-block;margin-right:2vh;margin-top:-1vh;float: right;">
                <el-upload accept=".pdf" :show-file-list="false" slot="append" ref="upload" name="file"
                  :multiple="false" action="htttps://ishare.horik.cn/api/" :on-change="onChange" :auto-upload="false">
                  <el-tag class="item-type3" style="display: inline-block;vertical-align: middle;"
                    @click="setpdfid(item.id)">
                    上传原文
                  </el-tag>
                </el-upload>
              </div>
              ...
              <div v-if="item.pdf === 1" style="display: inline-block;margin-right:2vh;margin-top:-1vh;float: right;">
                <el-tag class="item-type4" style="display: inline-block;vertical-align: middle;"
                  @click="delePdf(item.id)">
                  删除原文
                </el-tag>
              </div>
            ...
            <div>
              <div style="display: inline-block;margin-top: 1vh;color: grey" v-for="(aus, index) in item.authors">
                <div style="display: inline-block" v-if="index < item.author.length - 1"><b>{{ aus
                }}</b>&nbsp;;&nbsp;&nbsp
                </div>
                <div style="display: inline-block" v-if="index === item.author.length - 1"><b>{{ aus
                }}</b>&nbsp;&nbsp;&nbsp
        ...
        <el-row style="margin:auto; top:2vh">
          ...
          <el-col :span="16">
            <div class="block">
              <el-pagination layout="prev, pager, next" :total=this.total_page @current-change="handlechange"
                :current-page=this.now_page background>
              </el-pagination>
            </div>
          </el-col>
          <el-col :span="3">
